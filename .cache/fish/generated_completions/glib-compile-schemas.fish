...
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/glib-compile-schemas.1.gz
...
complete -c glib-compile-schemas -l dry-run -d 'Donât write gschemas. compiled.  This option can be used to check . gschema'
