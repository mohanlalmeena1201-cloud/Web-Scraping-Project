# apt-get
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man8/apt-get.8.gz
...
complete -c apt-get -l cli-version -d 'Requests a specific CLI version.  This is a pattern that takes a MAJOR'
