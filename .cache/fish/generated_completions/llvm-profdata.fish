...
complete -c llvm-profdata -l split-layout -d 'Split the profile data section to two with one containing sample profiles wit…'
...
complete -c llvm-profdata -l debuginfod -d 'Use debuginfod to find the associated executables that contain profile data a…'
complete -c llvm-profdata -l debug-file-directory -d 'Use provided local directories to search for executables that contain profile…'
complete -c llvm-profdata -l correlate -d 'Specify the correlation kind (debug_info or binary) to use when -debuginfod or'
complete -c llvm-profdata -o debug-file-directory
