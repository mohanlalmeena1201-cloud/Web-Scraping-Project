# gpgv
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/gpgv.1.gz
...
complete -c gpgv -l print-notation
complete -c gpgv -s N -d 'If the signature verifies print the notation name to stdout if it exists'
