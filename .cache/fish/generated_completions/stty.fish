# stty
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/stty.1.gz
...
complete -c stty -s F -l file -d 'open and use DEVICE instead of standard input'
