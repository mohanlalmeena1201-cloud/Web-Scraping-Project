# apt-mark
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man8/apt-mark.8.gz
complete -c apt-mark -s h -l help -d 'Show a short usage summary'
complete -c apt-mark -s v -l version -d 'Show the program version'
complete -c apt-mark -l audit -d 'Show audit (and notice) messages'
...
complete -c apt-mark -l cli-version -d 'Requests a specific CLI version.  This is a pattern that takes a MAJOR'
complete -c apt-mark -l no-color -l color -d 'Turn colors on or off'
