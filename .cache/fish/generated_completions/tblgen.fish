...
complete -c tblgen -o gen-arm-immcheck-types -d 'Generate arm_immcheck_types. inc for Clang'
...
complete -c tblgen -o gicombiner-debug-cxxpreds -d 'Add debug comments to all C++ predicates emitted by -gen-global-isel-combiner'
