# cksum
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/cksum.1.gz
...
complete -c cksum -s l -l length -d 'digest length in bits; must not exceed the max size and must be a multiple of…'
