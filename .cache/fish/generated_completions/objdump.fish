# objdump
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/objdump.1.gz
...
complete -c objdump -l offloading -d 'Display the content of the LLVM offloading sections and HIP offload bundles'
...
complete -c objdump -o fbasic-block-address-map -d instead
