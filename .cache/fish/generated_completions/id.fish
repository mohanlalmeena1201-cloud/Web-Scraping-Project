# id
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/id.1.gz
...
complete -c id -s n -l name -d 'print a name instead of a number, for -u,-g,-G'
complete -c id -s r -l real -d 'print the real ID instead of the effective ID, with -u,-g,-G'
complete -c id -s u -l user -d 'print only the effective user ID'
complete -c id -s z -l zero -d 'delimit entries with NUL characters, not whitespace; not permitted in default…'
