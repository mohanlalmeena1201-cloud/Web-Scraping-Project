# dc
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/dc.1.gz
...
complete -c dc -s e
complete -c dc -s f
complete -c dc -l max-recursion -d 'Limit recursion to a depth of at most depth .  (Mainly useful for debugging'
