# chcon
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/chcon.1.gz
...
complete -c chcon -s H -d 'if a command line argument is a symlink to a directory, traverse it'
complete -c chcon -s L -d 'traverse every symbolic link to a directory encountered'
complete -c chcon -s P -d 'do not traverse any symbolic links'
