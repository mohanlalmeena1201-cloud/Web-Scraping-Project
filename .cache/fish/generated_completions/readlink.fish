# readlink
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/readlink.1.gz
...
complete -c readlink -s s -l silent -d 'suppress most error messages (on by default if POSIXLY_CORRECT is not set)'
complete -c readlink -s v -l verbose -d 'report error messages (on by default if POSIXLY_CORRECT is set)'
