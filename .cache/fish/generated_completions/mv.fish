...
complete -c mv -l exchange -d 'exchange source and destination'
...
complete -c mv -l update -d 'control which existing files are updated; UPDATE={all,none,none-fail,older(de…'
complete -c mv -s u -d 'equivalent to --update[=\\,older\\/].   See below'
