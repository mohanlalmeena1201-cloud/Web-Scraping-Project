# patch
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/patch.1.gz
...
complete -c patch -s T -d 'Set the modification and access times of patched files from timestamps given …'
...
complete -c patch -l Remove -d 'Normally this option is unnecessary, since patch can examine the timestamps o…'
