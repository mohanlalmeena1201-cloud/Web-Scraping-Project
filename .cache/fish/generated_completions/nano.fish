...
complete -c nano -s E -l tabstospaces -d 'Convert each typed tab to spaces \\(em to the number of spaces that a tab at t…'
...
complete -c nano -s o -l operatingdir -d 'Change to the given directory, and allow reading and writing files only in th…'
...
complete -c nano -s r -l fill -d 'Set the target width for justifying and automatic hard-wrapping at this numbe…'
