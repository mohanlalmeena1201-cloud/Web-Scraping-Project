...
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/glib-compile-resources.1.gz
...
complete -c glib-compile-resources -l generate -d 'Write the output file in the format selected for by its filename extension:'
complete -c glib-compile-resources -l generate-source -d 'Instead of a writing the resource bundle in binary form, create a C source fi…'
...
complete -c glib-compile-resources -l c-name -d 'Specify the prefix used for the C identifiers in the code generated by'
...
complete -c glib-compile-resources -l internal -d 'By default, code generated by --generate-source declares all initialization f…'
