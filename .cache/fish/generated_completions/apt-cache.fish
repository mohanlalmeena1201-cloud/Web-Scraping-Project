# apt-cache
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man8/apt-cache.8.gz
...
complete -c apt-cache -l audit -d 'Show audit (and notice) messages'
...
complete -c apt-cache -l cli-version -d 'Requests a specific CLI version.  This is a pattern that takes a MAJOR'
complete -c apt-cache -l no-color -l color -d 'Turn colors on or off'
